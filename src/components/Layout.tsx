          ...
          <nav className="bg-white/60 backdrop-blur-md rounded-2xl shadow-sm pl-3 sm:pl-4 pr-2 py-2 w-full sm:w-auto flex items-center gap-3 sm:gap-6 shrink-0">
            ...
            <div className="hidden sm:flex items-center gap-6">
              <NavLink 
                to="/story" 
                className={({ isActive }) => 
                  `text-sm transition-opacity whitespace-nowrap ${isActive ? 'text-black font-bold' : 'text-gray-800 font-medium hover:opacity-60'}`
                }
              >
                Our story
              </NavLink>
            ...
            {/* CTA */}
            <Link to="/" className="ml-auto sm:ml-0 bg-black text-white text-sm font-medium px-4 sm:px-5 py-2 rounded-xl hover:bg-gray-800 transition-colors">
              Start a project
            </Link>
          </nav>
